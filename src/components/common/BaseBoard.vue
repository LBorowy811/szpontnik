...
const emit = defineEmits(['pieceClick', 'squareClick'])
...
.piece-cell { display: grid; place-items: center; cursor: pointer; }

.board-wrap{ position: relative; display: inline-block; }
.label-col{
  position: absolute; bottom: -26px; transform: translateX(-50%);
  font-weight: 600; font-size: 14px; color: #333; pointer-events: none;
}
.label-row{
  position: absolute; left: -26px; transform: translateY(-50%);
  font-weight: 600; font-size: 14px; color: #333; pointer-events: none;
}
</style>
